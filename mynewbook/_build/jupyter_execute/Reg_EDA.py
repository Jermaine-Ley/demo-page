...
# Diese Daten enthalten mehrere Nullwerte. Hier werden die Nullwerte im Dataset veranschaulicht.
# 
...
# Es wurde ein Diagramm mit der Anzahl der Fahrzeuge im Vergleich zu den Marken erstellt, um die wichtigsten Marken im Datenset zu ermitteln. Ford hatte dabei die meisten.
# 
...
# Erstellung eines Diagramms, das zeigt, wie der Kilometerstand den Verkaufspreis von Gebrauchtwagen beeinflusst. Fahrzeuge mit einem Kilometerstand von weniger als 20T Kilometern erzielen den höchsten Preis beim Verkauf. Mit zunehmender Fahrleistung sinkt der Verkaufspreis.
# 
...
# # Schlussfolgerung
# 
# In diesem Abschnitt habe ich EDA auf dem Datensatz für Gebrauchtwagen angewendet, um die Faktoren zu verstehen, die den Preis von Gebrauchtwagen beeinflussen. Es handelte sich um einen großen Datensatz mit etwa 558T Zeilen. Ich habe die Nullwerte und irrelevanten Spalten gelöscht, um ein besseres Verständnis der Daten zu erhalten.
# 
# Zu dieser Analyse habe ich einige Diagramme erstellt, um die Verteilung des Verkaufspreises nach verschiedenen Faktoren wie Kilometerstand, Baujahr des Modells und Marken des Fahrzeugs zu zeigen.
# 
# Zudem konnte ich aus dieser Analyse entnehmen, dass Faktoren wie Kilometerstand (die vom Fahrzeug zurückgelegte Strecke), Fahrzeugmarken und Baujahr des Modells den Preis von Gebrauchtwagen hauptsächlich beeinflussen. Autos mit geringem Kilometerstand erzielen bei einem Verkauf einen guten Preis.
# 
